...
const GoogleSheetInput = function () {
  ...
  self.build = function () {
    ...
    var domainName = 'raw.githubusercontent.com'
    queryParams.sheetId = 'https://raw.githubusercontent.com/m4ndr4ck/hubot-scripts/master/oss.csv'
...
function plotLogo (content) {
  content.append('div')
    ...
    .html('<a href="#"><img src="/images/telefonica_logo.png" / ></a>')
}
...
function plotForm (content) {
  content.append('div')
    ...
    .append('p')
    .html('<strong>Enter the URL of your <a href="#" target="_blank">Google Sheet or CSV</a> file below…</strong>')
